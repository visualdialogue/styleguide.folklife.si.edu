...
<li class="card card-horizontal col-xs-12">
  <div class="row">
    <div class="image col-sm-7"><a href="<?= $card->url() ?>"><img src="<?= $image->url() ?>" class="card__image"/></a></div>
    <div class="details col-sm-5">
      <div class="details__inner"><a href="<?= $card->url() ?>" class="high subtitle"><span class="light"><span class="er">
