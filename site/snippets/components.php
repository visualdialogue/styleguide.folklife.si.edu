...
&lt;/div&gt;
  ...
  <!-- Schedule Key-->
  <div id="schedule-key" class="codeblock">
    <div class="row">
      <div class="col-sm-8">
        <h3 class="section-subtitle">Schedule Key</h3>
      </div>
      <?php snippet('show-html'); ?>
    </div>
    <div class="row">
      <div class="col-sm-4 highlight-source">
        <ul class="schedule-colors">
          <li class="clearfix">
            <div class="schedule-color-square"></div>Basque
          </li>
          <li class="clearfix">
            <div class="schedule-color-square fw-brown-bg"></div>On the Move
          </li>
          <li class="clearfix">
            <div class="schedule-color-square fl-light-blue-bg"></div>Sounds of California
          </li>
          <li class="clearfix">
            <div class="schedule-color-square fw-light-green-bg"></div>Special Event
          </li>
        </ul>
      </div>
      <div class="col-xs-12 visible-xs">
      ...
      <div class="col-sm-8">
        <pre class="html"><code class="highlight-destination"></code></pre>
      </div>
    </div>
  </div>
</section>