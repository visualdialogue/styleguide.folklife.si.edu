...
<div class="row">
  <div class="album-info col-sm-12">
    ...
    <div class="album-sidebar-tab">ALBUMS 
    ...
    <div class="album-sidebar-tab">VIDEOS 
      <div aria-hidden="true" class="icon-right-open-mini"></div>
    </div>
    <div class="album-sidebar-tab">PLAYLISTS
      <div aria-hidden="true" class="icon-right-open-mini"></div>
    </div>
    <div class="album-sidebar-tab">TOOLS FOR TEACHING
      <div aria-hidden="true" class="icon-right-open-mini"></div>
    </div>
    <div class="album-sidebar-tab">ARTICLES
      <div aria-hidden="true" class="icon-right-open-mini"></div>
    </div>
  </div>
</div>