...
&lt;/div&gt;
	...
	&lt;/div&gt;
&lt;/div&gt;
</code></pre></div><div class="col-md-9"><pre class="sass"><code>// audio styles are too long to list here and have their own SASS file called audio.scss</code></pre></div></div></div><!-- Horizontal Playlist--><div class="codeblock"><a id="horizontal-playlist" class="anchor-link"></a><div class="row"><div class="col-sm-8"><h3 class="section-subtitle">Horizontal Playlist</h3></div><?php snippet('show-html'); ?><?php snippet('show-sass'); ?></div><div class="row"><script src="/assets/audio/myplaylist-calypso.js" type="text/javascript"></script><div class="card audio-card playlist-audio-card horizontal-audio-card-third full-border-horizontal-card col-xs-6 col-sm-4 card-xs-break-2"><div class="row"><div class="image col-xs-4"><a href="#"><img src="<?= $section->image('audio.png')->url() ?>" class="playlist-cover"/></a></div><div class="details col-xs-8"><div class="details-inner"><div class="title-wrapper"><a href="#" class="high title"><span class="light"><span class="er playlist-title">Quelbe!</span></span></a><div id="playlist-artist" class="artist">Stanley and the Ten Sleepless Nights</div></div><div class="audio-player"><audio id="playlist-audio" class="playlist-audio" src="/assets/audio/Music2same.mp3" data-mejsoptions='{"startVolume": 0.5, "setDimensions": false}'></audio><div class="playlist-controls"><div class="previous-button icon-folklife-leftarrow"></div><div class="next-button icon-folklife-rightarrow"></div></div></div></div></div></div></div><div class="col-xs-12 visible-xs"><?php snippet('show-html-mobile'); ?><?php snippet('show-sass-mobile'); ?></div><div class="col-md-8"><pre class="html"><code>&lt;div class="card audio-card playlist-audio-card horizontal-audio-card-third full-border-horizontal-card col-xs-6 col-sm-4 card-xs-break-2"&gt;
    &lt;div class="row"&gt;
